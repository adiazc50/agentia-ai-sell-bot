      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div className="space-y-4">
            <h3 className="text-2xl font-bold gradient-text">SoyAgentia</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <a href="tel:+573009006005" className="flex items-center gap-3 text-muted-foreground hover:text-accent transition-colors">
                <Phone size={18} className="text-accent" />
                <span>+57 300 900 6005</span>
              </a>
              <a href="https://wa.me/573009006005" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-muted-foreground hover:text-accent transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <a href="https://instagram.com/soy.agentia" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-muted-foreground hover:text-accent transition-colors">
                <Instagram size={18} className="text-accent" />
                <span>@soy.agentia</span>
              </a>
              <a href="mailto:contacto@soyagentia.com" className="flex items-center gap-3 text-muted-foreground hover:text-accent transition-colors">
                <Mail size={18} className="text-accent" />
                <span>contacto@soyagentia.com</span>
              </a>
            </div>
            <div className="pt-4">
              <h5 className="text-sm font-medium text-foreground mb-2">{t("footer.services")}</h5>
              <div className="space-y-1 text-sm text-muted-foreground">
                <p>• {t("footer.service1")}</p>
                <p>• {t("footer.service2")}</p>
                <p>• {t("footer.service3")}</p>
                <p>• {t("footer.service4")}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-border/50 pt-8 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-2">{t("footer.madeIn")}</p>
        </div>
      </div>
    </footer>
  );
