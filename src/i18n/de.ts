const de: Record<string, string> = {
  "nav.home": "Startseite", "nav.platforms": "Plattformen", "nav.plans": "Pläne", "nav.services": "Dienstleistungen", "nav.about": "Über uns", "nav.cities": "Städte", "nav.contact": "Kontakt", "nav.viewAllCities": "Alle Städte anzeigen", "nav.viewPlans": "Pläne und Preise", "nav.platformAI": "KI-Agenten für", "nav.login": "Anmelden", "nav.register": "Konto erstellen", "nav.logout": "Abmelden", "nav.myAccount": "Mein Konto", "nav.useCases": "Anwendungsfälle",
  "hero.worldwide": "Weltweite Abdeckung", "hero.countriesCities": "31 Länder und über 2.900 Städte", "hero.cityAndWorld": "{city} und weltweit", "hero.implementation": "Einrichtung in 5 Minuten", "hero.aiAgentsIn": "KI-Agenten in", "hero.salesAutomation": "", "hero.subtitle": "Automatisieren Sie Verkauf, Marketing und Support mit KI-Gesprächsagenten, integriert in WhatsApp, Web und CRM.", "hero.subtitleCity": "Agile Implementierung und kontinuierlicher Support für Unternehmen in {city}.", "hero.ctaWhatsapp": "Über WhatsApp kontaktieren", "hero.ctaUseCases": "Anwendungsfälle ansehen", "hero.stat.implementation": "Einrichtung", "hero.stat.responseTime": "Antwortzeit", "hero.stat.support": "Ständiger Support", "hero.trustLine": "Mehr als eine Agentur: eigene KI- und Robotikentwicklung für messbare Ergebnisse", "hero.badge.aiAgents": "KI-Agenten in {city}", "hero.badge.aiAgentsOnly": "KI-Agenten", "hero.badge.quickSetup": "Einrichtung in 5 Minuten", "hero.aiAgentsTitle": "KI-Agenten", "hero.subtitleGeneric": "Agile Implementierung und kontinuierlicher Support für Unternehmen weltweit.",
